...
@Component({
  selector: 'app-tabla-segmentos-admincli',
  templateUrl: './tabla-segmentos-admincli.component.html',
  styleUrls: ['./tabla-segmentos-admincli.component.css'],
  providers: [MessageService, ConfirmationService]
})
export class TablaSegmentosAdmincliComponent {
  dataSet: any[] = []
  ...
  obtenerDataSet() {
    this.segmentosServices.getDataByInstitucion(this.IdInstitucionSelected).subscribe(data => {
      this.dataSet = data
    })
  }
