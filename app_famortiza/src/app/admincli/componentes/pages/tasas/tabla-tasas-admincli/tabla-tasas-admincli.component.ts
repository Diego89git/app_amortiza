...
@Component({
  selector: 'app-tabla-tasas-admincli',
  templateUrl: './tabla-tasas-admincli.component.html',
  styleUrls: ['./tabla-tasas-admincli.component.css'],
  providers: [MessageService, ConfirmationService]
})
export class TablaTasasAdmincliComponent {
  dataSet: any[] = []
  ...
  obtenerDataSet() {
    this.tasasServices.getDataByInstitucion(this.IdInstitucionSelected).subscribe(data => {
      this.dataSet = data
    })
  }
  obtenerDataDropdown() {
    this.segmentoServices.getDataByInstitucion(this.IdInstitucionSelected).subscribe(data => {
