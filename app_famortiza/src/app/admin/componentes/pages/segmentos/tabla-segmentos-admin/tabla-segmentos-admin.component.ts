...
@Component({
  selector: 'app-tabla-segmentos-admin',
  templateUrl: './tabla-segmentos-admin.component.html',
  styleUrls: ['./tabla-segmentos-admin.component.css'],
  providers: [MessageService, ConfirmationService]
})
export class TablaSegmentosAdminComponent {
  dataSet: any[] = []
  ...
  //para dropdown
  selectedDropdown: any = { Id: 0, Nombre: 'Seleccione...' }
  dataDropdown: any[] = [];

  constructor(private segmentosServices: SegmentosService,
  ...
  obtenerDataSet() {
    this.segmentosServices.getData().subscribe(data => {
      this.dataSet = data
    })
  }
  obtenerDataDropdown() {
  ...
  openNew() {
    this.selectedDropdown = { Id: 0, Nombre: 'Seleccione...' }
    this.data = {};
  ...
  eliminarRegistro(id: number) {
    this.segmentosServices.deleteData(id).subscribe(
      (response) => {
